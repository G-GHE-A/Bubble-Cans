...
public class LOGICA_JOCULUI_NIVELUL4 : MonoBehaviour
{
    public Button doza1;
    public Button doza2;
    public Button doza3;
    ...
    private float xSlot1, xSlot2, xSlot3, xSlot4, xSlot5, xSlot6;
    ...
    void SeteazaPozitiiRandom()
    {
        do
        {
            List<int> numereDisponibile = new List<int> { 1, 2, 3, 4, 5, 6 };
            ...
            pozitie_corecta6 = numereDisponibile[0];
        } 
        while (pozitie_corecta1 == 1 || pozitie_corecta2 == 2 || pozitie_corecta3 == 3 || pozitie_corecta4 == 4 || pozitie_corecta5 == 5 || pozitie_corecta6 == 6);
    }
    ...
    void ActualizeazaIndiciu()
    {
        ...
        textIndiciu.text = "Doze corecte: " + numarCorecte + " / 6";
    }
