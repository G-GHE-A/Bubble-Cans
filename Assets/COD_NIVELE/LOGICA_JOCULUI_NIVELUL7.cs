...
public class LOGICA_JOCULUI_NIVELUL7 : MonoBehaviour
{
    public Button doza1;
    public Button doza2;
    public Button doza3;
    ...
    private float xSlot1, xSlot2, xSlot3, xSlot4, xSlot5, xSlot6, xSlot7, xSlot8, xSlot9;
    ...
    {
        do { 
        List<int> numereDisponibile = new List<int> { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
        ...
        pozitie_corecta9 = numereDisponibile[0];
        } while (pozitie_corecta1 == 1 || pozitie_corecta2 == 2 || pozitie_corecta3 == 3 || pozitie_corecta4 == 4 || pozitie_corecta5 == 5 || pozitie_corecta6 == 6 || pozitie_corecta7 == 7 || pozitie_corecta8 == 8 || pozitie_corecta9 == 9);
    }
